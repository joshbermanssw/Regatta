...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "supported-file-previews", String(localized: "settings.app.openSupportedFilesInCmux", defaultValue: "Open Supported Files in Regatta"), "cmd click file preview pdf image audio video quick look editor"),
        ...
        setting(.app, "markdown-viewer", String(localized: "settings.app.openMarkdownInCmuxViewer", defaultValue: "Open Markdown in Regatta Viewer"), "md markdown viewer"),
        ...
        setting(.sidebarAppearance, "open-pr-links", String(localized: "settings.app.openSidebarPRLinks", defaultValue: "Open Sidebar PR Links in Regatta Browser"), "pull request link browser"),
        setting(.sidebarAppearance, "open-port-links", String(localized: "settings.app.openSidebarPortLinks", defaultValue: "Open Sidebar Port Links in Regatta Browser"), "port link browser"),
        ...
        setting(.browser, "enable-browser", String(localized: "settings.browser.enabled", defaultValue: "Enable Regatta Browser"), "webview tabs links"),
        ...
        setting(.browser, "terminal-links", String(localized: "settings.browser.openTerminalLinks", defaultValue: "Open Terminal Links in Regatta Browser"), "click links browser"),
