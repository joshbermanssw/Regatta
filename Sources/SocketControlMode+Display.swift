...
extension SocketControlMode {
    ...
    var displayName: String {
        ...
        case .cmuxOnly:
            return String(localized: "socketControl.cmuxOnly.name", defaultValue: "Regatta processes only")
        case .automation:
    ...
    var description: String {
        ...
        case .cmuxOnly:
            return String(localized: "socketControl.cmuxOnly.description", defaultValue: "Only processes started inside Regatta terminals can send commands.")
        case .automation:
